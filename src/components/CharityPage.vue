<template>
  <div>
    <div class="main-content">
      <p>
        There is a lot of things in this world, which don’t get the needed attention. We hope we can bring the awareness to certain issues by making graphics about them, but we thought about other ways to contribute in some way.
